...
class Sam3D(ABC):
    ...
    def train_step(self, idx, sam_mask=None):
        ...
        if sam_mask is None:
            ...
            # save_image(seg_m.cpu().squeeze(), f'result_{idx}.png')

            # by seok, revise projected mask using YOLOv8
            ...
            # results = model_yolo.predict(source=img, imgsz=(h,w))
            ...
            #     yolo_m += img[(h2-h)//2:(h2+h)//2,:]
            # save_image(yolo_m, f'result_{idx}.png')
